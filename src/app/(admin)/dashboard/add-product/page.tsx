...
export default async function AddProductPage() {
  return (
    <div>
      ...
      <h2 className="mb-3 text-center text-lg font-bold">Add product manually</h2>
      <AddUpdateProductForm action={addProduct} />
      <div className="divider"></div>
      <h2 className="mb-3 text-center text-lg font-bold">Add product from file</h2>
      <UploadFromFileForm />
    </div>
  );
}
